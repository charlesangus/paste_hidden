...
- [x] **PANEL-01**: User can open a preferences dialog from the Anchors menu
...
| PANEL-01 | Phase 7 | Complete (checkbox missed before archive) |
...
- v1.1 requirements: 17 complete (PANEL-01 delivered via Phase 7-03, checkbox corrected)
- Mapped to phases: 31
- Unmapped: 0 ✓
